        ...
        >
          ...
          <Typography variant="h5" gutterBottom>
            ...
            <Typography variant="subtitle1" gutterBottom>
              ตามประกาศกระทรวงสาธารณสุข เรื่อง การกำหนดเกี่ยวกับสาถานที่ อุปกรณ์
              <br />
              ...
              <div key={i}>
                {a > 28.5 && (
                  <ListItem>
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox checked={true} color="primary" name="pass" />
                      }
                      label="ผ่าน"
                    />
                    <FormControlLabel
                      control={
                        <Checkbox checked={false} name="pass" color="primary" />
                      }
                      label="ไม่ผ่าน"
                    />
                  </ListItem>
                ...
                {a < 28.5 && (
                  <ListItemText>
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox checked={true} name="pass" color="primary" />
                      }
                      label="ไม่ผ่าน"
                    />
                  </ListItemText>
                    ...
                    {signature.map(
                      (sig) =>
                        sig.status === "ผู้รับอนุญาต / ผู้ดำเนินกิจการ" && (
                          <img src={sig.signatureUrl} width="55" height="55" />
                        )
                    )}
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    {signature.map(
